...
public class StudentsController {
        ...
        public ResponseEntity<PaginationAndList> search(@RequestParam(required = false) String fullName,
                ...
                var res = aFPS().select(List.of(
                                ...
                                aFPSField().field(
                                                "(select avg(sg.course_score) from  student_grade sg where sg.student_id = s.id ) ")
                                ...
                                .conditions(List.of(
                                                ...
                                                aFPSCondition().condition(
                                                                ...
                                                                .parameterName("fromAvgScore").value(fromAvgScore)
                                                                .build(),
                                                aFPSCondition().condition(
        ...
        public ResponseEntity<?> getHighSatStudents222(@RequestParam Integer sat) {
